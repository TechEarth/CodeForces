...
other at away ground. Hence, we need to track it via two loops. We would run into the case where we can the same team
...
occurrences. We update these occurrences and return that answer finally.   
'''
